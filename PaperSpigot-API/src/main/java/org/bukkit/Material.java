...
public enum Material {
    ...
    BARRIER(166), // Eldaria - Ajout de barrier
    SEA_LANTERN(169), // Ajout de la sea_lantern
    HAY_BLOCK(170),
    CARPET(171),
    HARD_CLAY(172),
    COAL_BLOCK(173),
    ...
    OBSIDIAN_FURNACE(200, Furnace.class),
    BURNING_OBSIDIAN_FURNACE(201, Furnace.class),
    REINFORCED_OBSIDIAN(202),
    WATER_PIPE(203),
    IRON_LADDER(204),
    SLIME_BLOCK(205),
    LIGNITE_ORE(206),
    ...
    MYSTERY_BOX(214),
    MAGIC_CHEST(215),
    ZINC_CHEST(216, Chest.class),
    CRONYXE_CHEST(217, Chest.class),
    KOBALT_CHEST(218, Chest.class),
    ZINC_BLOCK(219),
    CRONYXE_BLOCK(220),
    KOBALT_BLOCK(221),
    ELDARIUM_BLOCK(222),
    ...
    ZINC_AXE(511, 1, 1561),
    ZINC_HOE(512, 1, 1561),
    ZINC_GLOBAL_TOOL(513, 1, 1561),
    ZINC_HELMET(514, 1, 1561),
    ZINC_CHESTPLATE(515, 1, 1561),
    ZINC_LEGGINGS(516, 1, 1561),
    ZINC_BOOTS(517, 1, 1561),
    CRONYXE_SWORD(518, 1, 1561),
    CRONYXE_PICKAXE(519, 1, 1561),
    CRONYXE_SPADE(520, 1, 1561),
    CRONYXE_AXE(521, 1, 1561),
    CRONYXE_HOE(522, 1, 1561),
    CRONYXE_GLOBAL_TOOL(523, 1, 1561),
    CRONYXE_HELMET(524, 1, 1561),
    CRONYXE_CHESTPLATE(525, 1, 1561),
    CRONYXE_LEGGINGS(526, 1, 1561),
    CRONYXE_BOOTS(527, 1, 1561),
    KOBALT_SWORD(528, 1, 1561),
    KOBALT_PICKAXE(529, 1, 1561),
    KOBALT_SPADE(530, 1, 1561),
    KOBALT_AXE(531, 1, 1561),
    KOBALT_HOE(532, 1, 1561),
    KOBALT_GLOBAL_TOOL(533, 1, 1561),
    KOBALT_HELMET(534, 1, 1561),
    KOBALT_CHESTPLATE(535, 1, 1561),
    KOBALT_LEGGINGS(536, 1, 1561),
    KOBALT_BOOTS(537, 1, 1561),
    ELDARIUM_SWORD(538, 1, 1561),
    ELDARIUM_PICKAXE(539, 1, 1561),
    ELDARIUM_SPADE(540, 1, 1561),
    ELDARIUM_AXE(541, 1, 1561),
    ELDARIUM_HOE(542, 1, 1561),
    ELDARIUM_GLOBAL_TOOL(543, 1, 1561),
    ELDARIUM_HELMET(544, 1, 1561),
    ELDARIUM_CHESTPLATE(545, 1, 1561),
    ELDARIUM_LEGGINGS(546, 1, 1561),
    ELDARIUM_BOOTS(547, 1, 1561),
    REPAIR_ORB(548, 1, 900),
    DIVINE_ORB(549, 1, 1200),
    DYNAMITE(550),
    C4(551),
    TOMAHAWK(552),
    CHEST_ORB(553, 64, 5),
    EXPLORATION_BOOTS(554, 1, 1),
    WOOD_GLOBAL_TOOL(555, 1, 1561),
    STONE_GLOBAL_TOOL(556, 1, 1561),
