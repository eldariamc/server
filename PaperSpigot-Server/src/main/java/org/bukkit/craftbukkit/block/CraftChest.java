...
public class CraftChest extends CraftBlockState implements Chest {
    ...
    public Inventory getInventory() {
        ...
        if (world.getBlockTypeIdAt(x, y, z) == Material.CHEST.getId()) {
            ...
            large = true;
        } else if (world.getBlockTypeIdAt(x, y, z) == Material.ZINC_CHEST.getId()) {
            id = Material.ZINC_CHEST.getId();
        } else if (world.getBlockTypeIdAt(x, y, z) == Material.CRONYXE_CHEST.getId()) {
            id = Material.CRONYXE_CHEST.getId();
        } else if (world.getBlockTypeIdAt(x, y, z) == Material.KOBALT_CHEST.getId()) {
            id = Material.KOBALT_CHEST.getId();
        } else {
