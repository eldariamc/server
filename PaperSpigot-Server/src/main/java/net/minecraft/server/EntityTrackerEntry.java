        ...
        if (this.tracker instanceof EntityItem) {
            ...
            if (this.tracker instanceof EntityFishingHook) {
                ...
                if (this.tracker instanceof EntityFireball) {
                    ...
                    return new PacketPlayOutSpawnEntity(this.tracker, 50, ((EntityTNTPrimed) this.tracker).power); // Keyrisium - pass TNT power to spawn packet
                ...
                } else if (this.tracker instanceof EntityDynamite) {                   // Keyrisium
                    return new PacketPlayOutSpawnEntity(this.tracker, 100);
                } else if (this.tracker instanceof EntityC4) {
                    return new PacketPlayOutSpawnEntity(this.tracker, 101);
                } else if (this.tracker instanceof EntityTomahawk) {
                    return new PacketPlayOutSpawnEntity(this.tracker, 102);
                } else {
