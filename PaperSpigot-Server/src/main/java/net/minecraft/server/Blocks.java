...
public class Blocks
{
	...
	// j'existe
	public static final BlockFurnace FURNACE = (BlockFurnace) Block.REGISTRY.get("furnace");
	public static final BlockFurnace BURNING_FURNACE = (BlockFurnace) Block.REGISTRY.get("lit_furnace");
	...
	public static final Block SPRUCE_DOOR = (Block)Block.REGISTRY.get("spruce_door");
	public static final Block BIRCH_DOOR = (Block)Block.REGISTRY.get("birch_door");
	public static final Block JUNGLE_DOOR = (Block)Block.REGISTRY.get("jungle_door");
	public static final Block ACACIA_DOOR = (Block)Block.REGISTRY.get("acacia_door");
	public static final Block DARK_OAK_DOOR = (Block)Block.REGISTRY.get("dark_oak_door");
	...
	public static final Block LIGNITE_ORE = (Block)Block.REGISTRY.get("lignite_ore");
	public static final Block ZINC_ORE = (Block)Block.REGISTRY.get("zinc_ore");
	...
	public static final BlockChest MAGIC_CHEST = (BlockChest)Block.REGISTRY.get("magic_chest");
	public static final BlockChest ZINC_CHEST = (BlockChest)Block.REGISTRY.get("zinc_chest");
	public static final BlockChest CRONYXE_CHEST = (BlockChest)Block.REGISTRY.get("cronyxe_chest");
	public static final BlockChest KOBALT_CHEST = (BlockChest)Block.REGISTRY.get("kobalt_chest");
	public static final Block ZINC_BLOCK = (Block)Block.REGISTRY.get("zinc_block");
