...
public class TileEntityChest extends TileEntity implements IInventory {
    ...
    public TileEntityChest(int type, int size)
    {
        this.r = type;
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound.hasKey("Size"))
            this.items = new ItemStack[nbttagcompound.getByte("Size")];
        else
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setByte("Size", (byte) this.items.length);
    ...
    private boolean a(int i, int j, int k) {
        if (this.world == null) {
            ...
            return canBeLarge() && block instanceof BlockChest && ((BlockChest) block).a == this.j();
        }
    }
