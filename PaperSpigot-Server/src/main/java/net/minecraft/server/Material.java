...
public class Material {
	...
	public static final Material BRICK = (new Material(MaterialMapColor.m)).f().o(); // Keyrisium - Unmovable variant of STONE
	...
	public static final Material BARRIER = new MaterialGas(MaterialMapColor.b).f().o();
