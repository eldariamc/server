    ...
    public void attack(Entity entity) {
        if (entity.av()) {
            if (!entity.j(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    boolean flag = !world.paperSpigotConfig.disablePlayerCrits && this.fallDistance > 0.0F && !this.onGround && !this.h_().canClimb && !this.M() && !this.hasEffect(MobEffectList.BLINDNESS) && this.vehicle == null && entity instanceof EntityLiving;
