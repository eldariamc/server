...
public class DispenserRegistry {
    ...
    static void a() {
        ...
        BlockDispenser.a.a(Item.getItemOf(Blocks.TNT), new DispenseBehaviorTNT(1.0F));
        BlockDispenser.a.a(Item.getItemOf(Blocks.GREEK_TNT), new DispenseBehaviorTNT(3.0F));
    }
