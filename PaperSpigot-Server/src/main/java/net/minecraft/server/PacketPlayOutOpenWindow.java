...
public class PacketPlayOutOpenWindow extends Packet {
    ...
    public PacketPlayOutOpenWindow(int i, int j, String s, int k, boolean flag, double furnaceSpeed) {
        this(i, j, s, k, flag);
    ...
    public void a(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        if (this.b == 2) {
            this.furnaceSpeed = packetdataserializer.readDouble();
        } else if (this.b == 11) {
    ...
    public void b(PacketDataSerializer packetdataserializer) throws IOException {
        if ( packetdataserializer.version < 16 )
        {
            ...
            if (this.b == 2) {
                packetdataserializer.writeDouble(this.furnaceSpeed);
            } else if ( this.b == 11 )
            {
