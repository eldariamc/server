...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    protected int blockX = -1; // Keyrisium - private -> protected
    protected int blockY = -1; // Keyrisium - private -> protected
    protected int blockZ = -1; // Keyrisium - private -> protected
    protected Block inBlockId; // Keyrisium - private -> protected
    protected boolean inGround; // Keyrisium - private -> protected
    public int shake;
