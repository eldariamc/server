...
public class TileEntityFurnace extends TileEntity implements IWorldInventory {
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        this.fuelSpeed = nbttagcompound.getShort("FuelSpeed");
        this.furnaceSpeed = nbttagcompound.getDouble("SpeedModifier");
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setShort("FuelSpeed", (short) this.fuelSpeed);
        nbttagcompound.setDouble("SpeedModifier", this.furnaceSpeed);
    ...
    public void h() {
        ...
        if (!this.world.isStatic) {
            ...
            if (flag != this.burnTime > 0) {
                flag1 = true;
                BlockFurnace furnace = (BlockFurnace) world.getType(x, y, z);
                furnace.a(this.burnTime > 0, this.world, this.x, this.y, this.z);
            }
        }
    ...
    public int fuelTime(ItemStack itemstack) {
        if (itemstack == null) {
            ...
            if (item instanceof ItemTool && ((ItemTool) item).j().equals("WOOD"))
                return 200;
            if (item instanceof ItemSword && ((ItemSword) item).j().equals("WOOD"))
                return 200;
            if (item instanceof ItemHoe && ((ItemHoe) item).i().equals("WOOD"))
                return 200;
            if (item == Items.STICK)
                return 100;
            if (item == Items.COAL)
            ...
            if (item == Items.LAVA_BUCKET)
                return 20000;
            if (item == Item.getItemOf(Blocks.SAPLING))
                return 100;
    ...
    public boolean b(int i, ItemStack itemstack) { // isItemValidForSlot()
