...
public abstract class EntityLiving extends Entity {
    ...
    public ClimbInfo h_() {
        ...
        return new ClimbInfo(block instanceof BlockLadder || block == Blocks.VINE,
                block == Blocks.IRON_LADDER ? 2 : 1);
    }
    ...
    public int aV() {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
                float l = ((ItemArmor) itemstack.getItem()).c;
    ...
    protected float applyMagicModifier(DamageSource damagesource, float f) {
        if (damagesource.isStarvation()) {
            ...
            if (f <= 0.0F || this.hasEffect(MobEffectList.FEATHER_FALLING) && damagesource == DamageSource.FALL) {
                return 0.0F;
            } else {
    ...
    public void e(float f, float f1) {
        ...
        if (this.M() && (!(this instanceof EntityHuman) || !((EntityHuman) this).abilities.isFlying)) {
            ...
            if (info.canClimb) {
                ...
                if (this.motY < -0.15D*info.speed) {
                    this.motY = -0.15D*info.speed;
                }
            ...
            info = this.h_();
            if (this.positionChanged && info.canClimb) {
                this.motY = 0.2D*info.speed;
            }
    ...
    public class ClimbInfo {
        ...
        ClimbInfo(boolean canClimb, int speed) {
