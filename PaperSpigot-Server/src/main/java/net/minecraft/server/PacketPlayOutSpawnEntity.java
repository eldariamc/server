...
public class PacketPlayOutSpawnEntity extends Packet {
    ...
    public PacketPlayOutSpawnEntity(Entity entity, int i, float tntPower) {
        this(entity, i);
    ...
    public void a(PacketDataSerializer packetdataserializer) {
        ...
        if (this.j == 50)
            this.tntPower = packetdataserializer.readFloat();
    }
    ...
    public void b(PacketDataSerializer packetdataserializer) {
        ...
        if (this.j == 50)
            packetdataserializer.writeFloat(this.tntPower);
    }
